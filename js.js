...
let Blockes_Container_left = document.querySelector(".window-left");
let Blockes_Container_right = document.querySelector(".window-right");
...
function flipBlock(selectedBlock) {
  ...
  if (
    ...
    selectedBlock.classList.contains("matched")
  )
    return;
...
//   let container = document.querySelector(".building");
//   container.style.display = "none";
  ...
  let allFlippedBlocks = allBlocks.filter(
    (block) =>
